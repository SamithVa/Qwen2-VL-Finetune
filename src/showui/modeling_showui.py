        ...
        **kwargs,
        ...
        Args:
            ...
            kwargs (`dict`, *optional*):
                ...
                into the model
        """
        # print("input_hidden_state", hidden_states.shape)
        dtype = hidden_states.dtype # [bsz, seq, emb_dim]
        ...
        if patch_pos is not None and layer_skip_ratio != 0:
            ...
            # print("select_hidden_state", selected_hidden_states.shape)
            # import sys 
            # sys.exit()
...
class ShowUIPreTrainedModel(PreTrainedModel):
    ...
    _supports_static_cache = False # Qwen2-VL, this is set to false
